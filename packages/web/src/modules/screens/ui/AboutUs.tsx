        ...
        <Grid container={true} direction="row">
          ...
          >
            <Typography variant="subheading" component="h3">
              ...
              classes. In last 11 years, PCCP division has evolved significantly
              and works in two segments of classes, namely, Sub-Junior classes
              (V – VIII) and Junior classes (IX – X).The two segments have
              different teaching methodologies and so are their targets. In
              Junior classes, the targeted competitive examinations are National
              Standard Examination in Junior Science (NSEJS, 1st stage of
              ...
              of the real one. In Sub-Junior classes, the targeted competitive
              examinations are National Mathematics Talent Competitions (NMTC),
              Private Mathematics and Science Olympiads and other private
              Olympiads which can be cleared by following CBSE curriculum of the
              ...
              NCERT curriculum and conducting various academic workshops to make
              students understand the application of several concepts. Other
              than the academic delivery of concepts in Sub-Junior classes, we
              also aim at inculcating life skills in students as per the current
              guidelines of World Health Organization (WHO). The life skills
              include social skills, thinking skills and emotional skills. These
              skills are enhanced through a variety of activities conducted at
              the campus of each study center of Resonance.
            </Typography>
          </Grid>
          <Grid
            item={true}
