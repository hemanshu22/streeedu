          ...
          >
            <div>
              ...
              <Typography variant="body1" gutterBottom={true}>
                ...
                homework checking schedule etc. This planner helps students and
                parents in planning the strategy for studies and progress ahead.
              </Typography>
            </div>
          </Grid>
          <Grid item={true} xs={12} sm={1} md={1} lg={1} />
          ...
          >
            <div>
              ...
              <Typography variant="body1" gutterBottom={true}>
                ...
                maximize the absorption of concepts. Students in Resonance study
                not only through chalkboard method but also through interactive
          ...
          >
            <div>
              ...
              <Typography variant="body1" gutterBottom={true}>
                ...
                regular intervals to check the progress of students. At the end
                of the chapter, pictorial and textual summaries are given for a
                quick revision at the time of tests. After the summaries,
                exercises are given with carefully selected questions of
                different types and difficulty levels for comprehensive
                practice.
              </Typography>
            </div>
          </Grid>
        ...
        <Grid container={true}>
          ...
          >
            <div>
              ...
              <br />
              <Typography variant="body1" gutterBottom={true}>
                In addition to chapter modules, DPPs are given to students. Each
                DPP includes questions from all the chapters taught before it,
                even if they've already been covered in earlier DPPs. These
                problems need to be solved within a mentioned time interval. It
                helps in boosting revisions and practice of time management at
                home.
              </Typography>
            </div>
          </Grid>
          ...
          >
            <div>
              ...
              <Typography variant="body1" gutterBottom={true}>
                ...
                immediate practice of a learned concept enhances the chances of
                absorption of the concept. Students who do regular homework and
                participate in classroom discussion are very much likely to
                succeed in the competitive examinations. Scientifically.
              </Typography>
            </div>
          </Grid>
          <Grid item={true} xs={12} sm={1} md={1} lg={1} />
          ...
          >
            <div>
              ...
              <Typography variant="body1" gutterBottom={true}>
                ...
                performance at the national level. These tests are conducted in
                objective as well as subjective manner periodically and keep a
                check of both current as well as previously taught syllabus.
              </Typography>
            </div>
          </Grid>
          ...
          >
            <div>
              ...
              <Typography variant="body1" gutterBottom={true}>
                ...
                each subject at the website of Resonance. This helps students to
                identify their strength and weakness. The SAPER can be found at
                www.pccp.resonance.ac.in, under student zone.
              </Typography>
            </div>
          </Grid>
          <Grid item={true} xs={12} sm={1} md={1} lg={1} />
          ...
          >
            <div>
              ...
              <Typography variant="body1" gutterBottom={true}>
                ...
                for good ranks in competitive examinations. In this test series,
                students (Resonites as well as Non Resonites) appear and
                showcase their talent which is benchmarked at national level
                with All India Ranks and helps in analysis of strong and weak
                topics.
              </Typography>
            </div>
          </Grid>
          ...
          >
            <div>
              ...
              <Typography variant="body1" gutterBottom={true}>
                ...
                due to unavoidable circumstances or late joining. These classes
                run throughout the year so that students can catch up anytime
                they feel left out. Doubt classes also run throughout the year
                to clear doubts of students after regular classes. Doubt classes
                are also used by the students to ask the doubts from
                supplementary books.
              </Typography>
            </div>
          </Grid>
